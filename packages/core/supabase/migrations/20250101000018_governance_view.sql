-- factoredui schema: governance support
...
CREATE OR REPLACE VIEW factoredui.v_experiment_summary AS
SELECT
...
LEFT JOIN factoredui.experiment_variants v
  ON v.experiment_id = e.id
LEFT JOIN factoredui.experiment_assignments a
  ON a.experiment_id = e.id AND a.variant_key = v.variant_key
LEFT JOIN factoredui.experiment_exposures x
