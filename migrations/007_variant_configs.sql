-- observe schema: SDUI opt-in component configurations
...
CREATE TABLE observe.variant_configs (
...
CREATE INDEX idx_variant_configs_component
  ON observe.variant_configs (component_path, version DESC);

ALTER TABLE observe.variant_configs ENABLE ROW LEVEL SECURITY;
